...
import com.arkenidar.products.Caffe;
import com.arkenidar.products.Cappuccino;

public class Main {
    public static void main(String[] args) {
        System.out.println("Distributore automatico! (vending machine)");
        ...
        System.out.println(distributoreDiBevande);
    }
}